...
export const HELIUS_RPC_ENDPOINT = retrieveEnvVariable('HELIUS_RPC_ENDPOINT', logger);
...
export const SHRED_ENDPOINT = retrieveEnvVariable('SHRED_ENDPOINT', logger);
...
export const MINIMUM_PROFIT = Number(retrieveEnvVariable('MINIMUM_PROFIT', logger));
